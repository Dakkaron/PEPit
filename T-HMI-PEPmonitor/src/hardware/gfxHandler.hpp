...
void drawSprite(DISPLAY_T* display, TFT_eSprite* sprite, int32_t dstX, int32_t dstY, int32_t maskingColor, float alpha, int32_t srcX=0, int32_t srcY=0, int32_t srcW=-1, int32_t srcH=-1, int32_t flags=0);
